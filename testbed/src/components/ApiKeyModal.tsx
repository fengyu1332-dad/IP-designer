...
export function ApiKeyModal({
  ...
  const [sdApiKey, setSdApiKey] = useLocalStorage<string>('ip-designer-sd-api-key', '');
  const [sdApiBase, setSdApiBase] = useLocalStorage<string>('ip-designer-sd-api-base', 'https://api.stability.ai/v1');
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl transform transition-all animate-slide-up my-8">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div className="pb-6 border-b border-slate-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-sm font-semibold text-slate-700">LLM API (金句生成)</h4>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h4 className="text-sm font-semibold text-slate-700">Stable Diffusion API (可选)</h4>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="sk-..."
                    className="w-full px-4 py-3 pr-12 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all bg-slate-50"
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <input
                  type="text"
                  value={sdApiBase}
                  onChange={(e) => setSdApiBase(e.target.value)}
                  placeholder="https://api.stability.ai/v1"
                  className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all bg-slate-50"
                />
                <p className="text-xs text-slate-400 mt-1">
                  从 <a href="https://platform.stability.ai/" target="_blank" className="text-purple-500 hover:underline">Stability AI</a> 获取免费 API Key
                </p>
              </div>
            </div>
          </div>
